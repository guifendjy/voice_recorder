...
`;let C=F(q,v),D=C.querySelector(".middle");h.error?v.error=h.error:h.then(({canvas:e})=>{e.style.borderBottom="1px solid #d42a02",D.appendChild(e)});root.appendChild(C);
